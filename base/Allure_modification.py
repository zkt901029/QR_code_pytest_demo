#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @Time    : 2022-06-09 14:07
# @Author  : 狐狸糊涂
# @File    : Allure_modification.py
# @Software: PyCharm
"""
    用于设置Allure报告窗口标题设置为自定义内容信息。
"""
import json
import os

route = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
...
def set_windos_title(new_title):
    ...
    # report_title_filepath = r"E:\python\QR_code_pytest_demo\report_allure\index.html"
    # report_title_filepath = r".\report_allure\index.html"

    # 获取HTML测试报告的绝对路径

    report_title_filepath = route + r'\report_allure\index.html'
...
# title_filepath = r".\report_allure\widgets\summary.json"
title_filepath = route + r'\report_allure\widgets\summary.json'
